...
- EmptyTablesEnhancer actif : oui
- ResponsiveTablesEnhancer actif : oui
...
| `/administration/correspondence/[id]` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/correspondence/new` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/inbox` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/minutes` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/minutes/[id]` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/minutes/[id]/edit` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/minutes/new` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/tasks` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/tasks/[id]` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/tasks/[id]/edit` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/tasks/new` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/administration/transmissions` | church-app | oui | oui | oui | oui | 0 | - | - |
...
| `/events/new` | church-app | oui | oui | oui | oui | 0 | - | - |
...
| `/finance/budgets` | church-app | oui | oui | oui | oui | 0 | - | - |
...
| `/finance/offerings` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/finance/offerings/[id]` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/finance/offerings/new` | church-app | oui | oui | oui | oui | 0 | - | - |
...
| `/patrimony/assets` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/patrimony/assets/[id]` | church-app | oui | oui | oui | oui | 0 | - | - |
...
| `/teachings/new` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/testimonies` | church-app | oui | oui | oui | oui | 0 | - | - |
| `/unauthorized` | public | non | oui | oui | oui | 0 | - | - |
