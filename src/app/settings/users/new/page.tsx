    ...
    <AppShell>
      <div className="mx-auto max-w-5xl space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-7 text-blue-50">
                Créez un compte pour Pasteur T, Pasteur A, Chargé AFP,
                Responsable D, Logisticien, Secrétaire ou utilisateur simple.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="mt-6 rounded-3xl bg-[#EAF3FA] p-4 text-sm font-black text-[#03357A]">
            Après création, ouvrez Utilisateurs & rôles pour cocher uniquement
